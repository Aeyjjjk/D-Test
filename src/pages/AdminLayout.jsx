  ...
  const Sidebar = (
    <nav className="flex flex-col h-full">
      <div className="flex items-center gap-3 px-4 h-16 border-b border-line">
        <div className="h-8 w-8 rounded-md bg-orange flex items-center justify-center text-inkOnOrange font-head font-extrabold shrink-0">
          W
        </div>
        <span className="font-head font-bold text-ink text-sm leading-tight">
          Wact DA Test
        </span>
      </div>
    ...
    <div className="min-h-screen bg-bg lg:flex">
      ...
      <div className="lg:hidden flex items-center justify-between h-14 px-4 border-b border-line bg-surface sticky top-0 z-20">
        <div className="flex items-center gap-2">
          <div className="h-7 w-7 rounded-md bg-orange flex items-center justify-center text-inkOnOrange font-head font-extrabold text-sm">
            W
          </div>
          <span className="font-head font-bold text-ink text-sm">Wact DA Test</span>
        </div>
        <div className="flex items-center gap-2">
          <ThemeToggle />
          <button
